...
be sampled. The empirical design compares RNN, Bayesian RNN, CA-RNN, and
...
\begin{enumerate}[label=RQ\arabic*.]
    ...
    \item Does CA--RNN add forecast value beyond the likelihood-only
...
traditional baselines, and paired-bootstrap identities. Twenty-four automated
...
block boundaries can affect autocorrelation estimates; the corresponding
uncertainty intervals are consequently interpreted as diagnostic rather than
definitive.
...
adequacy. Its relative advantage under the synthetic frozen stress appears only
after scale and dependence shifts become material, providing evidence of a
robustness crossover rather than nominal dominance. Strong volatility-aware
